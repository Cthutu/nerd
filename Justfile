...
clean:
    rm -rf _*
    find tests -type f \( -name '*.host.c' -o -name '*.input.c' -o -name '*.out' -o -name '*.format' -o -name '*.input.n' -o -name '*.lsp.in' -o -name '*.lsp.out' -o -name '_*.hir' -o -name '_*.ll' -o -name '*.link.ll' -o -name '*.input.m*.ll' -o -name '*.m*.ll' \) -delete
