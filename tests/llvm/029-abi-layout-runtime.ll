ffi "c" strlen (text: ^i8) -> usize
ffi "c" snprintf (buffer: ^void, size: usize, format: ^i8, ...) -> i32
...
dynarray.alloc.0:
  %t2 = call ptr @nrt_mem_alloc(i64 32, i64 16, ptr @.macro.file.m0, i32 28)
...
dynarray.grow.2:
  ...
  %t25 = getelementptr inbounds i8, ptr %t24, i64 32
...
dynarray.alloc.4:
  %t36 = call ptr @nrt_mem_alloc(i64 32, i64 16, ptr @.macro.file.m0, i32 29)
  ...
  %t40 = getelementptr inbounds i8, ptr %t36, i64 32
...
dynarray.ready.5:
  ...
  %t42 = getelementptr inbounds i8, ptr %t41, i64 -32
...
dynarray.reserve.grow.6:
  ...
  %t50 = getelementptr inbounds i8, ptr %t49, i64 32
...
dynarray.free.8:
  %t61 = getelementptr inbounds i8, ptr %t59, i64 -32
...
define internal i32 @fn.5() {
  ...
  %t19 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr %t14, i64 %t18, ptr @.str.m0.3, i32 7)
  %t20 = call i64 @nrt_string_builder_mark()
  %t21 = alloca { ptr, i64 }
  ...
  %t23 = alloca { ptr, i64 }
  call void @nrt_to_string_usize(ptr %t23, i64 %t10)
  call void @nrt_string_builder_append_string(ptr %t23)
  %t24 = alloca { ptr, i64 }
  store { ptr, i64 } { ptr @.str.m0.5, i64 1 }, ptr %t25
  call void @nrt_to_string_string(ptr %t24, ptr %t25)
  call void @nrt_string_builder_append_string(ptr %t24)
  %t26 = alloca { ptr, i64 }
  call void @nrt_to_string_i32(ptr %t26, i32 %t19)
  call void @nrt_string_builder_append_string(ptr %t26)
  %t27 = alloca { ptr, i64 }
  call void @nrt_string_builder_finish(ptr %t27, i64 %t20)
  ...
  %t29 = call i1 @nrt_string_eq(ptr %t30, ptr %t31)
...
@$main = hidden alias i32 (), ptr @fn.5
