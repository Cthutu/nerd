...
¬
define i32 @fn.0({ i64, { i32, i32 } } %choice) {
...
define i32 @fn.1() {
  ...
  %t4 = call i32 @fn.0({ i64, { i32, i32 } } %t3)
  %t5 = insertvalue { i32, i32 } poison, i32 3, 0
  %t6 = insertvalue { i64, { i32, i32 } } poison, i64 1, 0
  %t7 = insertvalue { i64, { i32, i32 } } %t6, { i32, i32 } %t5, 1
  %t8 = call i32 @fn.0({ i64, { i32, i32 } } %t7)
  %t9 = add i32 %t4, %t8
  ret i32 %t9
}
@$describe_choice = alias i32 ({ i64, { i32, i32 } }), ptr @fn.0
