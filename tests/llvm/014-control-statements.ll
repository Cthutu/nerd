...
@.macro.file.m0 = private unnamed_addr constant [42 x i8] c"tests/llvm/014-control-statements.input.n\00"
...
define internal i32 @fn.0() {
  ...
  call void @nrt_nerd_assert(i1 %t0, ptr @.assert.source_path.m0.0, i32 2, ptr %t1)
