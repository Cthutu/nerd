...
@.macro.file.m0 = private unnamed_addr constant [35 x i8] c"tests/language/108-size-operator.t\00"
...
define internal i32 @fn.1() {
  ...
  %t9 = alloca { ptr, i64 }
  call void @nrt_to_string_usize(ptr %t9, i64 4)
  ...
  %t18 = alloca { ptr, i64 }
  call void @nrt_to_string_usize(ptr %t18, i64 16)
  ...
  %t21 = alloca { ptr, i64 }
  call void @nrt_to_string_usize(ptr %t21, i64 16)
  ...
  %t24 = alloca { ptr, i64 }
  call void @nrt_to_string_usize(ptr %t24, i64 8)
  ...
  %t27 = alloca { ptr, i64 }
  call void @nrt_to_string_usize(ptr %t27, i64 0)
  ...
  %t30 = alloca { ptr, i64 }
  call void @nrt_to_string_usize(ptr %t30, i64 8)
  ...
  %t33 = alloca { ptr, i64 }
  call void @nrt_to_string_usize(ptr %t33, i64 0)
