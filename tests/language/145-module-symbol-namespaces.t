...
¬
¬
fn test$namespaced_a$test
return i32:10
end
fn test$namespaced_b$test
return i32:32
end
fn main
$0 = call fn()->i32:test$namespaced_a$test
$1 = call fn()->i32:test$namespaced_b$test
$2 = i32:$0 + i32:$1
return i32:$2
end¬
#include <stdint.h>
...
void init() {}
int $test$namespaced_a$test() {
    return 10;
}
int $test$namespaced_b$test() {
    return 32;
}
int $main() {
    int $0 = $test$namespaced_a$test();
    int $1 = $test$namespaced_b$test();
    int $2 = $0 + $1;
    return $2;
}
