...
bind main = fn.0
func fn.0() -> void {
  expr void call bind.0(prn)(string concat(<unknown> "Hello, ", <unknown> "world!"))
}
¬
; nerd llvm-ir 0
; generated from HIR

@.macro.file.m0 = private unnamed_addr constant [60 x i8] c"tests/language/011-adjacent-strings.t\00"
