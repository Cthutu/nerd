...
$20 = (i32,i32):$19.0
local score$left$on48 = i32:$20
$21 = (i32,i32):$19.1
local score$right$on50 = i32:$21
label L13
$22 = i32:score$left$on48 + i32:score$right$on50
$0 = i32:$22
jump L1
label L12
$24 = enum(3)
...
int $score(enum9 $value) {
    ...
    goto L1;
    L6: ;
    enum9 $14 = (enum9){.tag = 2};
    bool $15 = $value.tag == $14.tag;
    if (!$15) goto L12;
    tuple8 $16 = $value.data.$Pair;
    int $17 = $16._0;
    int $18 = $16._1;
    tuple8 $19 = $value.data.$Pair;
    int $20 = $19._0;
    int $score$left$on48 = $20;
    int $21 = $19._1;
    int $score$right$on50 = $21;
    L13: ;
    int $22 = $score$left$on48 + $score$right$on50;
    $0 = $22;
    goto L1;
    L12: ;
    enum9 $24 = (enum9){.tag = 3};
...
int $main() {
    ...
    enum9 $0 = (enum9){.tag = 0};
    enum9 $a = $0;
    enum9 $1 = (enum9){.tag = 1, .data.$Some = 5};
    enum9 $b = $1;
    tuple8 $2 = (tuple8){._0 = 10, ._1 = 20};
    enum9 $3 = (enum9){.tag = 2, .data.$Pair = $2};
    enum9 $c = $3;
    enum9 $4 = (enum9){.tag = 3, .data.$Text = (string){.data = (u8*)"hello", .count = 5}};
    enum9 $d = $4;
