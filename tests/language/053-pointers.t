...
func fn.0() -> i32 {
  ...
  expr void call bind.0(prn)(string interpolate(<unknown> "array pointer = ", [3]i32 index(^[3]i32 local.1(array_ptr), untyped integer 0)))
  expr void call bind.0(prn)(string interpolate(<unknown> "elem pointer = ", i32 index(^i32 local.2(elem_ptr), untyped integer 0)))
  expr void call bind.0(prn)(string interpolate(<unknown> "literal pointer = ", [3]i32 index(^[3]i32 local.3(literal_ptr), untyped integer 0)))
...
@.macro.file.m0 = private unnamed_addr constant [30 x i8] c"tests/language/053-pointers.t\00"
...
define internal i32 @fn.0() {
  ...
  %t14 = alloca { ptr, i64 }
  call void @nrt_to_string_i32(ptr %t14, i32 %t13)
  ...
  %t26 = alloca { ptr, i64 }
  call void @nrt_to_string_i32(ptr %t26, i32 %t25)
  call void @nrt_string_builder_append_string(ptr %t26)
  %t27 = alloca { ptr, i64 }
  call void @nrt_string_builder_finish(ptr %t27, i64 %t21)
  ...
  %t39 = alloca { ptr, i64 }
  call void @nrt_to_string_i32(ptr %t39, i32 %t38)
  call void @nrt_string_builder_append_string(ptr %t39)
  call void @nrt_string_builder_append_byte(i8 93)
  %t40 = alloca { ptr, i64 }
  call void @nrt_string_builder_finish(ptr %t40, i64 %t29)
