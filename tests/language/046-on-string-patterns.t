...
@.macro.file.m0 = private unnamed_addr constant [40 x i8] c"tests/language/046-on-string-patterns.t\00"
...
on.next.2:
  ...
  %t9 = call i1 @nrt_string_eq(ptr %t7, ptr %t8)
...
define internal i32 @fn.2() {
  ...
  %t28 = alloca { ptr, i64 }
  call void @nrt_to_string_i32(ptr %t28, i32 %t27)
