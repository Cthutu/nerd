...
import import.1 __impl_arena_alloc from module.1(test.reexport).decl.3: <unknown>
import import.2 __impl_arena_alloc_array from module.1(test.reexport).decl.4: <unknown>
import import.3 __impl_arena_alloc_bytes from module.1(test.reexport).decl.5: fn (^arena^arena, usize) -
import import.4 __impl_arena_reset from module.1(test.reexport).decl.6: fn (^arena^arena) -
import import.5 __impl_arena_mark from module.1(test.reexport).decl.7: fn (^arena^arena)
import import.6 __impl_arena_restore from module.1(test.reexport).decl.8: fn (^arena^arena, u32) -
import import.7 __impl_arena_done from module.1(test.reexport).decl.9: fn (^arena^arena) -
