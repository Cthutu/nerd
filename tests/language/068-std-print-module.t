...
import import.2 __impl_132_alloc from module.1(core).decl.16: <unknown>
import import.3 __impl_132_alloc_array from module.1(core).decl.17: <unknown>
import import.4 __impl_132_alloc_bytes from module.1(core).decl.18: fn (^arena^arena, usize) -
import import.5 __impl_132_reset from module.1(core).decl.19: fn (^arena^arena) -
import import.6 __impl_132_mark from module.1(core).decl.20: fn (^arena^arena)
import import.7 __impl_132_restore from module.1(core).decl.21: fn (^arena^arena, u32) -
import import.8 __impl_132_done from module.1(core).decl.22: fn (^arena^arena) -
bind pr = import.0
bind prn = import.1
bind __impl_132_alloc = import.2
bind __impl_132_alloc_array = import.3
bind __impl_132_alloc_bytes = import.4
bind __impl_132_reset = import.5
bind __impl_132_mark = import.6
bind __impl_132_restore = import.7
bind __impl_132_done = import.8
bind print = module.1
bind main = fn.0
func fn.0() -> void {
