...
define internal i32 @fn.0() {
  ...
  %t4 = call i64 @nrt_string_builder_mark()
  ...
  %t10 = alloca { ptr, i64 }
  call void @nrt_to_string_i32(ptr %t10, i32 %t9)
  ...
  %t45 = alloca { ptr, i64 }
  call void @nrt_to_string_i32(ptr %t45, i32 %t42)
  ...
  call void @nrt_to_string_string(ptr %t48, ptr %t49)
  call void @nrt_string_builder_append_string(ptr %t48)
  %t50 = alloca { ptr, i64 }
  ...
  %t57 = alloca { ptr, i64 }
  call void @nrt_to_string_i32(ptr %t57, i32 %t54)
