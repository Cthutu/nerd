...
main :: fn () {
    ...
    core.prn($"{number} {text} {explicit} {from_value} {chosen}")
}
¬
0
¬
...
import import.0 prn from module.1(core).decl.14: fn (string) -> void
import import.1 __impl_arena_alloc from module.1(core).decl.18: <unknown>
import import.2 __impl_arena_alloc_array from module.1(core).decl.19: <unknown>
import import.3 __impl_arena_alloc_bytes from module.1(core).decl.20: fn (^arena^arena, usize) -
import import.4 __impl_arena_reset from module.1(core).decl.21: fn (^arena^arena) -
import import.5 __impl_arena_mark from module.1(core).decl.22: fn (^arena^arena) 
import import.6 __impl_arena_restore from module.1(core).decl.23: fn (^arena^arena, u32) -
import import.7 __impl_arena_done from module.1(core).decl.24: fn (^arena^arena) -
bind prn = import.0
