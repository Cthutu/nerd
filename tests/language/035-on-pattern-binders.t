...
func fn.1() -> i32 {
  expr void call bind.0(prn)(string interpolate(<unknown> "0: ", u32 call bind.3(test_branch)(u32 0)))
  expr void call bind.0(prn)(string interpolate(<unknown> "2: ", u32 call bind.3(test_branch)(u32 2)))
  expr void call bind.0(prn)(string interpolate(<unknown> "5: ", u32 call bind.3(test_branch)(u32 5)))
  return i32 cast(u32 call bind.3(test_branch)(u32 bind.2(size)) as i32)
}
¬
; nerd llvm-ir 0
; generated from HIR

@.macro.file.m0 = private unnamed_addr constant [40 x i8] c"tests/language/035-on-pattern-binders.t\00"
...
define internal i32 @fn.1() {
  ...
  %t4 = alloca { ptr, i64 }
  call void @nrt_to_string_u32(ptr %t4, i32 %t3)
  ...
  %t11 = alloca { ptr, i64 }
  call void @nrt_to_string_u32(ptr %t11, i32 %t10)
  ...
  %t17 = call i32 @fn.0(i32 5)
  %t18 = alloca { ptr, i64 }
  call void @nrt_to_string_u32(ptr %t18, i32 %t17)
