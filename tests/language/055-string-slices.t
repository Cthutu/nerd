...
@.macro.file.m0 = private unnamed_addr constant [35 x i8] c"tests/language/055-string-slices.t\00"
...
define internal i32 @fn.0() {
  ...
  call void @nrt_to_string_string(ptr %t43, ptr %t44)
  ...
  %t53 = alloca { ptr, i64 }
  call void @nrt_to_string_usize(ptr %t53, i64 %t52)
  ...
  %t61 = load i8, ptr %t60
  %t62 = alloca { ptr, i64 }
  call void @nrt_to_string_u8(ptr %t62, i8 zeroext %t61)
