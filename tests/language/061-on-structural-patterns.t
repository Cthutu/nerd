...
@.macro.file.m0 = private unnamed_addr constant [44 x i8] c"tests/language/061-on-structural-patterns.t\00"
...
define internal i32 @fn.1({ i32, i32, { ptr, i64 } } %point) {
  ...
  %t3 = call i1 @nrt_string_eq(ptr %t1, ptr %t2)
...
define internal i32 @fn.3() {
  ...
  %t15 = alloca { ptr, i64 }
  call void @nrt_to_string_i32(ptr %t15, i32 %t14)
  call void @nrt_string_builder_append_string(ptr %t15)
  %t16 = alloca { ptr, i64 }
  ...
  call void @nrt_to_string_string(ptr %t19, ptr %t20)
  call void @nrt_string_builder_append_string(ptr %t19)
  %t21 = insertvalue { i32, i32 } poison, i32 4, 0
  %t22 = insertvalue { i32, i32 } %t21, i32 9, 1
  %t23 = call i32 @fn.0({ i32, i32 } %t22)
  %t24 = alloca { ptr, i64 }
  call void @nrt_to_string_i32(ptr %t24, i32 %t23)
  ...
  %t33 = alloca { ptr, i64 }
  call void @nrt_to_string_i32(ptr %t33, i32 %t32)
  ...
  call void @nrt_to_string_string(ptr %t37, ptr %t38)
  ...
  %t43 = alloca { ptr, i64 }
  call void @nrt_to_string_i32(ptr %t43, i32 %t42)
  call void @nrt_string_builder_append_string(ptr %t43)
  %t44 = alloca { ptr, i64 }
  ...
  call void @nrt_to_string_string(ptr %t47, ptr %t48)
  call void @nrt_string_builder_append_string(ptr %t47)
  ...
  %t53 = alloca { ptr, i64 }
  call void @nrt_to_string_i32(ptr %t53, i32 %t52)
  ...
  call void @nrt_to_string_string(ptr %t57, ptr %t58)
  ...
  %t63 = alloca { ptr, i64 }
  call void @nrt_to_string_i32(ptr %t63, i32 %t62)
  call void @nrt_string_builder_append_string(ptr %t63)
  %t64 = alloca { ptr, i64 }
  ...
  call void @nrt_to_string_string(ptr %t67, ptr %t68)
  call void @nrt_string_builder_append_string(ptr %t67)
  ...
  call void @nrt_to_string_string(ptr %t73, ptr %t74)
  call void @nrt_string_builder_append_string(ptr %t73)
  %t75 = alloca { ptr, i64 }
