...
typedef enum : u8 {
    ...
    IR_OP_STORE_FIELD,
    IR_OP_INDEX,
    IR_OP_ADDRESS_OF_FIELD_PTR,
    IR_OP_ADDRESS_OF_INDEX_PTR,
    ...
    IR_OP_DYNARRAY_FREE,
    IR_OP_DYNARRAY_POP,
    IR_OP_DYNARRAY_DELETE,
    IR_OP_DYNARRAY_SWAP_DELETE,
    IR_OP_DYNARRAY_RESIZE,
    IR_OP_DYNARRAY_RESIZE_UNDEFINED,
    IR_OP_ADDRESS_OF,
