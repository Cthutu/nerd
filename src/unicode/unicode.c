...
internal bool
unicode_is_in_intervals(u32 cp, const UnicodeInterval* intervals, usize count)
{
    usize low  = 0;
    usize high = count;
...
internal bool unicode_is_continuation(u8 byte)
{
    return (byte & 0xC0u) == 0x80u;
}

internal usize unicode_utf8_decode_first(const u8* data,
                                         usize     count,
                                         u32*      out_cp)
{
...
internal usize unicode_codepoint_cell_width(u32 cp)
{
    static const UnicodeInterval combining[] = {
        ...
        {0x0898, 0x089F},   {0x08CA, 0x0902},   {0x093A, 0x093A},
        ...
        {0x13430, 0x13440}, {0x13447, 0x13455}, {0x16AF0, 0x16AF4},
    ...
    static const UnicodeInterval wide[] = {
        ...
        {0x3000, 0x303E},   {0x3041, 0x33FF},   {0x3400, 0x4DBF},
        {0x4E00, 0xA4C6},   {0xA960, 0xA97C},   {0xAC00, 0xD7A3},
        {0xF900, 0xFAFF},   {0xFE10, 0xFE19},   {0xFE30, 0xFE6B},
        {0xFF01, 0xFF60},   {0xFFE0, 0xFFE6},   {0x1F004, 0x1F004},
